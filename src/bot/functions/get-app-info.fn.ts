...
const KNOWLEDGE_BASE = {
  identity: {
    ...
    notABot:
      'Nunca confirmar que es bot/IA. Presentarse como Gus, asistente financiero.',
    creator:
      'Propiedad intelectual de TallyFinance SPA. No compartir detalles técnicos.',
  },
  ...
  channels: {
    ...
    linking:
      'Vincular cuenta desde la app web o pidiendo código de vinculación al bot',
  },
  ...
  security: {
    ...
    bankAccess:
      'No accedemos a cuentas bancarias. Solo registramos lo que el usuario cuenta.',
  ...
  faq: [
    {
      q: '¿Es seguro?',
      a: 'Sí. No accedemos a cuentas bancarias. Datos encriptados.',
    },
    {
      q: '¿Es gratis?',
      a: 'Plan gratuito disponible. Planes premium para más features.',
    },
    {
      q: '¿Funciona sin internet?',
      a: 'No, necesita conexión para registrar y consultar.',
    },
    {
      q: '¿Se puede usar sin la web?',
      a: 'Sí para registrar gastos. La web es para configuración avanzada.',
    },
  ],
};
