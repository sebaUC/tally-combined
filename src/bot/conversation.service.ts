...
// Key prefix retained as `conv:v3:` to avoid orphaning in-flight Redis
// conversations during the rename. Safe to rebase once histories expire (4h TTL).
const CONV_KEY = (userId: string) => `conv:v3:${userId}`;
const TTL = 4 * 3600; // 4 hours
const MAX_ENTRIES = 50;

/**
 * Conversation Service — Redis-backed Gemini message history.
 *
